<?php
namespace Tualo\Office\DSTestSuite\Commands;
use Garden\Cli\Cli;
use Garden\Cli\Args;
...
class Setup extends BaseSetup implements ISetupCommandline{
    ...
    public static function getCommandName(): string { return 'dstestsuite'; }
    public static function getCommandDescription(): string { return 'perform a complete dstestsuite setup'; }
    ...
    public static function run(Args $args) { 
        ...
        PostCheck::formatPrintLn(['blue'], "Installing all needed SQL procedures for dstestsuite module");
